...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brwon", "bob@gamil.com", new DateTime(1998, 4, 25), 1200.0, d1);
            Seller s2 = new Seller(2, "Maria Green", "mariab@gamil.com", new DateTime(1979, 12, 03), 1600.0, d3);
            Seller s3 = new Seller(3, "Alex Grey", "alex@gamil.com", new DateTime(1993, 7, 17), 2300.0, d4);
            Seller s4 = new Seller(4, "Martha red", "martha@gamil.com", new DateTime(2000, 5, 09), 1000.0, d2);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gamil.com", new DateTime(1997, 7, 11), 1400.0, d2);
            Seller s6 = new Seller(6, "alex Pink", "alexpink@gamil.com", new DateTime(1988, 3, 15), 3000.0, d3);
